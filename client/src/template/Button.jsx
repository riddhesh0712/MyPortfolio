...
export const Button = (props) => {
  return (
    <div>
        <button class="btn-37 relative block p-4 px-16 overflow-hidden text-white bg-thirtaryColor uppercase cursor-pointer hover:text-white hover:bg-secondary-30" type={props.type}>
