...
const BlogCard = ({ image, title, date, comments, description }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-secondaryColor rounded-lg overflow-hidden shadow-xl  text-white transform hover:scale-105 transition-transform duration-300 hover:cursor-pointer">
      ...
      <div className="md:w-2/3 p-3 md:p-6">
        ...
        <button className=" hover:text-white hover:bg-secondary-30 border border-thirtaryColor hover:bg-thirtaryColor transition-all ease-in-out duration-300  py-2  px-2 md:px-4 rounded">
          READ MORE &gt;
        </button>
      </div>
    </div>
